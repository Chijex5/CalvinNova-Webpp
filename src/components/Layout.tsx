          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-indigo-200 dark:text-gray-300 mb-4">
                  The trusted marketplace for college students to buy and sell
                  items directly on campus.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="text-indigo-200 dark:text-gray-400 hover:text-white dark:hover:text-white transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="#" className="text-indigo-200 dark:text-gray-300 hover:text-white dark:hover:text-white transition-colors">
                      About Us
                    </a>
                  </li>
                  <li>
            ...
            <div className="border-t border-indigo-800 dark:border-gray-700 mt-8 pt-6 text-center text-indigo-300 dark:text-gray-400">
