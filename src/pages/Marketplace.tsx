...
const ProductCard = ({ product, onEdit, currentUserId = null }: {
  ...
  const getConditionColor = (condition: string) => {
    switch (condition) {
      case 'new': return 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300';
      case 'good': return 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300';
      case 'used': return 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300';
      ...
      <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300">
            ...
            {productImages.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110"
                >
                  <ChevronLeft className="w-4 h-4 text-gray-800 dark:text-gray-200" />
                </button>
                <button
                  onClick={goToNextImage}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110"
                >
            ...
            <button
              onClick={openGallery}
              className="absolute bottom-2 right-2 p-2 rounded-full bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110"
            >
        ...
        <div className="p-4">
          {/* Title */}
          <h3 onClick={() => navigate(`/product/${product.slug}`)}
          className="font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline text-lg mb-2 line-clamp-2 group-hover:text-indigo-600 dark:group-hover:text-blue-400 transition-colors duration-200">
            {product.title}
          </h3>
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-gray-800 rounded-t-2xl p-6 max-h-[80vh] overflow-y-auto">
        ...
        <button
          onClick={onClose}
          className="w-full bg-indigo-600 dark:bg-blue-600 hover:bg-indigo-700 dark:hover:bg-blue-700 text-white py-3 rounded-xl font-medium transition-colors duration-200"
        >
          Apply Filters
        </button>
      </div>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-700 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-indigo-600 dark:bg-blue-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-blue-700 transition-colors duration-200"
          >
            Try Again
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="lg:hidden flex items-center space-x-2 px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
            >
